...
class StoreBuyListRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'productId.int' => 'O campo ID do produto deve conter um número inteiro',
    ...
    {
        return $this->getProductId() ?? $this->getExternalProductId();
    }
